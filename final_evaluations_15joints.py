...
class Text2MotionDatasetV2(data.Dataset):
    def __init__(self, opt, data_path, mean, std, w_vectorizer):
        ...
        for name in tqdm(id_list):
            ...
            text_data = []
            flag = False
            with cs.open(pjoin(opt.text_dir, name[6:] + '.txt')) as f:
...
def get_dataset_motion_loader(opt_path, data_path, batch_size, device):
    ...
    opt.text_dir = '/liujinxin/code/Hu/dataset/HumanML3D/test_txt'
    #opt.data_root = './dataset/'
    # opt.text_dir = '/liujinxin/code/Hu/dataset/HumanML3D/texts'
...
if __name__ == '__main__':
    ...
    pred_root = f'./test/pred_joint_vecs/amass_1000_hu_sft_union15_1-10-16-48-17'
    ...
    gt_loader, gt_dataset= get_dataset_motion_loader(dataset_opt_path, 'test/gt_joint_vecs/test_npy_true', batch_size, device)
