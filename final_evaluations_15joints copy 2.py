...
class Text2MotionDatasetV2(data.Dataset):
    def __init__(self, opt, data_path, mean, std, w_vectorizer):
        ...
        print("id_list .....", data_path,  len(id_list))
        new_name_list = []
        length_list = []
...
def get_dataset_motion_loader(opt_path, data_path, batch_size, device):
    ...
    opt.text_dir = './dataset/test/train_50_txt'
    #opt.data_root = './dataset/'
    #opt.text_dir = '/storage/liujinxin/code/Hu2/output/benchmark/amass15/test'
...
def evaluate_matching_score(motion_loader):
    ...
    print('len motion_loader  ', len(motion_loader))
    with torch.no_grad():
...
if __name__ == '__main__':
    ...
    motion_loader_name = 'hu_sft_union15_1-10-16-48-17'
    ...
    batch_size = 30
    pred_root = './test/pred_joint_vecs/hu_sft_union15_1-10-16-48-17'
    ...
    gt_loader, gt_dataset= get_dataset_motion_loader(dataset_opt_path, 'test/gt_joint_vecs/train', batch_size, device)
